...
def train(oa, network, oaName, training_ints, testing_ints, measure, OUTFILE):
...
def main(OUTFILE):
    ...
    with open(OUTFILE,'w') as f:
        f.write('{},{},{},{},{},{}\n'.format('iteration','MSE_train','MSE_tst','acc_train','acc_test','elapsed'))
...
if __name__ == "__main__":
    ...
    #main(OUTFILE = './output/NN/rhc_10_log.csv')
    #main(OUTFILE = './output/NN/1rhc_10_log.csv')
    #main(OUTFILE = './output/NN/2rhc_10_log.csv')
    #main(OUTFILE = './output/NN/3rhc_10_log.csv')
    main(OUTFILE = './output/NN/4rhc_10_log.csv')
